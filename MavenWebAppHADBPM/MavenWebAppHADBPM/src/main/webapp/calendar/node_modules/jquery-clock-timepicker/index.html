 ...
 <head>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
	  ...
	  $('.amPmTime').clockTimePicker({useAmPm:true});
	  ...
	  $('.durationMinMax').clockTimePicker({duration:true, minimum:'1:00', maximum:'5:00'});
  ...
  <style type="text/css">
    ...
    .time { display:inline-block; font-size:26px; padding:5px; text-align:center; width:90px; margin-top:5px; }
  </style>
 </head>
 <body>
  <div class="main">
   ...
   <!--p class="example">
    <strong>Time picker with AM/PM</strong><br />
	<i>{ useAmPm: true }</i><br />
    <input class="time amPmTime" type="text" value="8:30 pm" />
   </p-->
   <p class="example">
   ...
   <p class="example">
	...
	<i>{ duration: true, minimum: '1:00', maximum: '5:00' }</i><br />
